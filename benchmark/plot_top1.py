...
def plot_dockq(df):
    ...
    plt.savefig(f'db5_test_top1_dockq.png', dpi=300, bbox_inches='tight')

# List of file paths
test_set = 'db5_test'
df1 = pd.read_csv(f'{test_set}_top1_dockq_dfmdock_msa.csv')
df2 = pd.read_csv(f'{test_set}_top1_dockq_afm.csv')
