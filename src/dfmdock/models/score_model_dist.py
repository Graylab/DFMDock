...
from models.score_net_dist import Score_Net
...
class Score_Model(pl.LightningModule):
    ...
    def step(self, batch, batch_idx):
        ...
        dist = (pos[:, None, 1, :] - pos[None, :, 1, :]).norm(dim=-1)
        dist_bins = get_bins(dist, 3.25, 50.75, 40)
        dist_matrix = F.one_hot(dist_bins, num_classes=40).float()
