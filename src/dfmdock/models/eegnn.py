...
class E_GCL(nn.Module):
    ...
    def message_model(self, source, target, edge_attr):
        if edge_attr is None:  # Unused.
    ...
    def forward(self, h, edge_index, coord, edge_attr=None, node_attr=None, lig_mask=None):
        ...
        # edge update
        edge_attr = self.edge_model(h[row], h[col], radial, edge_attr)

        # message passing
        edge_feat = self.message_model(h[row], h[col], edge_attr)
