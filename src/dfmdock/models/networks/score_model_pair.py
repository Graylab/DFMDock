...
from models.score_net_pair import Score_Net
...
from utils.dockq import get_DockQ
...
class Score_Model(pl.LightningModule):
    ...
    def loss_fn(self, batch, eps=1e-5):
        ...
        if self.use_contrastive_loss:
            ...
            el_loss = F.cross_entropy(-1 * energy_stack, target.long(), reduction='none') * (1.0 - dockq)
        else: 
