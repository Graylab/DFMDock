...
from dfmdock.models.score_net_pair import Score_Net
...
class Score_Model(pl.LightningModule):
    ...
    def loss_fn(self, batch, eps=1e-5):
        ...
        # interface loss
        dist_loss = distogram_loss(dist, pos_gt) * 0.3

        # total losses
        loss = tr_loss + rot_loss + ec_loss + el_loss + ires_loss + dist_loss
...
@hydra.main(version_base=None, config_path="/scratch4/jgray21/lchu11/graylab_repos/DFMDock/configs/model", config_name="score_model_pair.yaml")
