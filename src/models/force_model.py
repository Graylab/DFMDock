...
from models.force_net import Force_Net
...
class Force_Model(pl.LightningModule):
    def __init__(
        self,
        model,
        diffuser,
    ...
    def loss_fn(self, batch, eps=1e-5):
        ...
        # total losses
        loss = tr_loss + rot_loss + el_loss + ires_loss
        losses = {"tr_loss": tr_loss, "rot_loss": rot_loss, "el_loss": el_loss, "ires_loss": ires_loss, "loss": loss}
...
@hydra.main(version_base=None, config_path="/scratch4/jgray21/lchu11/graylab_repos/DFMDock/configs/model", config_name="force_model.yaml")
