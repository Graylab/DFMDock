...
from models.egnn_net_2 import EGNN_Net
...
class DFMDock(pl.LightningModule):
    ...
    def loss_fn(self, batch, eps=1e-5):
        ...
        # total losses
        loss = tr_loss + rot_loss + ec_loss + el_loss + dist_loss * 0.1 + ires_loss + conf_loss * 0.1
        losses = {
            "tr_loss": tr_loss, 
            "rot_loss": rot_loss, 
            "ec_loss": ec_loss, 
...
@hydra.main(version_base=None, config_path="/scratch4/jgray21/lchu11/graylab_repos/DFMDock/configs/model", config_name="DFMDock_2.yaml")
